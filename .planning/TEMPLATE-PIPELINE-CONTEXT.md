...
1. Runtime de producao nao aplicava `templateId + templateData` no `dispatch-messages` antes de enviar.
...
3. Conversao Telegram no backend de producao estava divergente da logica canonica (`src/lib/rich-text.ts`).
