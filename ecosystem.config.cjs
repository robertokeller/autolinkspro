...
const effectivePorts = {
  ...
  amazon: isValidPort(portOverrides.amazon) ? Number(portOverrides.amazon) : DEFAULT_PORTS.amazon,
};
...
const apps = [
  {
    ...
    env: { ...baseApp.env, PORT: "3116", DB_POOL_MAX: String(dbPoolMaxPerWorker), BURST_THRESHOLD_PER_BUCKET: String(Number(process.env.BURST_THRESHOLD_PER_BUCKET) || 500) },
    restart_delay: 5000,
  },
  {
    ...baseApp,
  ...
  {
    ...baseApp,
    name: "autolinks-amazon",
    ...npmRunConfig("svc:amazon:start"),
    env: { ...baseApp.env, PORT: String(effectivePorts.amazon) },
  },
  {
    ...baseApp,
