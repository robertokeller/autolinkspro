...
export type CheckoutProvider = "kiwify";
...
/** Per-period pricing and checkout config for a plan */
export interface PlanPeriodConfig {
  ...
  /** Provider used to generate checkout for this period */
...
export interface Plan {
  ...
  kiwifyCheckoutUrl?: string;
  /** Provider used for checkout when no period override exists */
  checkoutProvider?: CheckoutProvider;
...
const START_LIMITS: PlanLimits = {
  ...
  // 2 automations x 3 groups = 6 total slots; 2 routes x 3 groups = 6 total slots
...
const PRO_LIMITS: PlanLimits = {
  ...
  // 5 automations x 5 groups = 25 total; 10 routes x 5 groups = 50 total
