...
export function ChannelPlatformIcon({ platform, className, ...props }: { platform: ChannelPlatform } & IconProps) {
  if (platform === "whatsapp") return <WhatsAppIcon className={className} {...props} />;
