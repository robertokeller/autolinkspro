  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogOpenChange}>
      <DialogContent className="max-w-lg max-h-[92dvh] overflow-y-auto">
        ...
        <DialogFooter className="flex-col-reverse sm:flex-row sm:justify-between gap-2 border-t pt-4 border-border">
          ...
          <Button onClick={handleSchedule} disabled={submitting}>
            ...
            {submitting ? (isEditing ? "Salvando..." : "Agendando...") : (isEditing ? "Salvar Agendamento" : "Criar Agendamento")}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
