...
export function ViewportAdaptationProvider({ children }: ViewportAdaptationProviderProps) {
  useEffect(() => {
    ...
    const updateViewportVars = () => {
      ...
      const pageX = viewport.isTiny ? 10 : viewport.isMobile ? 12 : viewport.isTablet ? 18 : 24;
      const pageY = viewport.isTiny ? 12 : isShort ? 14 : viewport.isMobile ? 16 : viewport.isTablet ? 20 : 24;
      const headerHeight = viewport.isTiny ? 54 : viewport.isMobile ? 56 : viewport.isTablet ? 58 : 56;
      const touchTargetSize = viewport.isTouch ? (viewport.isTiny ? 42 : 44) : 36;
      const mobileBottomNavHeight = viewport.isMobile ? (viewport.isTiny ? 68 : 74) : 0;
      ...
      root.style.setProperty("--mobile-bottom-nav-offset", viewport.isMobile ? `${mobileBottomNavHeight}px` : "0px");
